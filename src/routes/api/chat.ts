...
Informations vérifiées : produits — films plastiques, sacs industriels, housses de protection, gaines plastiques et films pour serres agricoles ; secteurs — industrie, agriculture, agroalimentaire, logistique et construction ; équipe — 50 à 100 personnes ; sites — siège à Casablanca et usine à Had Soualem ; services — fabrication sur mesure, conseil technique, production industrielle et préparation logistique ; téléphone — ${contact.phone} et ${contact.phone2} ; e-mail — ${contact.email} ; horaires — lundi à vendredi 9h–18h, samedi 9h–13h à confirmer avant visite, dimanche fermé.
